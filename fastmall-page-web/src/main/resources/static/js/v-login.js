...
$(function () {
    ...
    if (usernameCookie!=null){
        $('#loginForm input[name="username"]').val(usernameCookie);
    }
    ...
    $('#loginForm').on('submit',function (e) {
        ...
        apis.passportApis.userLogin(username,password,rememberMe,function (result) {
            if (result.code==code.SUCCESS){
                ...
                if (callbackUrl!=null){
                    ...
                    window.location.href=protocol_host.page+"/?user-token="+result.data;
                }
